...
def create_chain():
    ...
    prompt = PromptTemplate(
        ...
        3. Guidelines:
           - Start your response naturally and vary your tone
           ...
           - Include a section titled 'Common Medications' listing 1-2 OTC meds that may help
           - Always include a disclaimer to consult a doctor first
        Assistant:"""
    )
